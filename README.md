...
**UXHuman** is an open framework defining the human, ethical, and interactional layer of the emerging **IntentWeb**—a distributed web architecture where **intent**, not attention, is the organizing principle.  
...
- **[Governance and Collaboration Framework](https://github.com/UXHuman-org/UXHuman/blob/main/docs/governance/UXHuman-Governance-&-Collaboration-Framework.md)** — Defines contribution, certification, and maintenance processes.  
...
- Default license: **Creative Commons Attribution 4.0 International (CC BY 4.0)** — see [LICENSE](LICENSE)  
